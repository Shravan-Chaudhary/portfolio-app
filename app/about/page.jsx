...
function About() {
  return (
    ...
    <div className='flex flex-col max-w-xl mx-auto pt-24 h-full justify-center space-y-8 items-center bg-body-color dark:bg-dark-bg'>
      {/* Heading Container */}
      <div className='w-fit backdrop-blur-lg mx-auto text-dark-bg dark:text-light-white drop-shadow-lg h-fit px-6 py-2 sm:px-12 text-center text-2xl opacity-95 space-y-2 border-b border-footer-color'>
        <h2 className='text-4xl font-semibold'>About</h2>
      </div>
      {/* Paragraph Container */}
      <div className='flex text-justify p-3 px-4 space-y-4'>
        <p className='text-lg sm:text-xl text-dark-bg dark:text-light-white leading-7'>
